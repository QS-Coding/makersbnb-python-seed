...
def test_new_booking(test_web_address, page, db_connection):
    ...
    page.locator('startDate').fill('12/07/2024')
    page.locator('endDate').fill('20/07/2024')
    # page.fill("input[name='startDate']","12/07/2024")
    # page.fill("input[name='endDate']","20/07/2024")
